...
Du côté des pays (points bleus numérotés), on observe que :
    ...
    Les pays 11 (Grèce) et 15 (Espagne) se situent à l’extrémité inférieure de PC3, traduisant des particularités liées à des variables comme Electricity Prices et First Time Asylum Applicants.

Le plan PC2 vs PC3 révèle donc des regroupements et des oppositions supplémentaires entre les pays, qui étaient moins visibles dans le plan précédent. Ce type d’analyse permet de compléter la compréhension des relations complexes entre les variables et les pays européens.
